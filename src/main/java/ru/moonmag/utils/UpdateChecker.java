...
public class UpdateChecker {
    ...
    private final String repo = "MoonMag53/SpaceChest";
    ...
    public void checkForUpdates() {
        Bukkit.getScheduler().runTaskAsynchronously(this.plugin, () -> {
            try {
                URL url = new URL("https://api.github.com/repos/MoonMag53/SpaceChest/releases/latest");
                ...
                if (conn.getResponseCode() == 200) {
                    ...
                    if (!currentVersion.equalsIgnoreCase(latestVersion)) {
                        ...
                        this.logger.warning("Скачать: https://github.com/MoonMag53/SpaceChest/releases/tag/" + latestVersion);
                    } else {
